...
export const GET: APIRoute = async () => {
  ...
  const staticPages = [
    ...
    url("/comparateur", "0.7", "monthly", today),
    url("/parrainage", "0.6", "monthly", today),
    url("/nos-engagements", "0.6", "monthly", today),
    url("/location-cargo-paris", "0.8", "monthly", today),
    url("/location-velo-electrique-entreprise-paris", "0.8", "monthly", today),
    url("/blog/rss.xml", "0.4", "daily", today),
